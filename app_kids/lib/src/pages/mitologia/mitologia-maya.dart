...
class MitologiaMaya extends StatelessWidget {
  @override
...
Widget _customTopPrimerDios(List<dynamic> data, BuildContext context){
  return Container(
    child: Column(
      children: [
        Text(data.elementAt(1)['mayas']['nombre-dios1'],style: TextStyle(color: Colors.black, fontSize: 20.0)),
        ClipRRect(
            borderRadius: BorderRadius.all(Radius.circular(20.0)),
            child: FadeInImage(
                    image: NetworkImage(data.elementAt(1)['mayas']['img-dios-1']), 
...
Widget _customBotPrimerDios(List<dynamic> data, BuildContext context){
  return Container(
    child: Column(
      children: [
        Text(data.elementAt(1)['mayas']['dios1'],style: TextStyle(color: Colors.black, fontSize: 20.0)),
      ]
    )
  );
}
...
Widget _customTopSegundoDios(List<dynamic> data, BuildContext context){
  return Container(
    child: Column(
      children: [
        Text(data.elementAt(1)['mayas']['nombre-dios2'],style: TextStyle(color: Colors.black, fontSize: 20.0)),
        ClipRRect(
            borderRadius: BorderRadius.all(Radius.circular(20.0)),
            child: FadeInImage(
                    image: NetworkImage(data.elementAt(1)['mayas']['img-dios-2']), 
                    placeholder: AssetImage('assets/loading.gif'),
                    height: 250,
                    fit: BoxFit.cover
                    ) 
...
Widget _customBotSegundoDios(List<dynamic> data, BuildContext context){
  return Container(
    child: Column(
      children: [
        Text(data.elementAt(1)['mayas']['dios2'],style: TextStyle(color: Colors.black, fontSize: 20.0)),
      ]
    )
  );
}
...
Widget _customTopTercerDios(List<dynamic> data, BuildContext context){
  return Container(
    child: Column(
      children: [
        Text(data.elementAt(1)['mayas']['nombre-dios3'],style: TextStyle(color: Colors.black, fontSize: 20.0)),
        ClipRRect(
            borderRadius: BorderRadius.all(Radius.circular(20.0)),
            child: FadeInImage(
                    image: NetworkImage(data.elementAt(1)['mayas']['img-dios-3']), 
                    placeholder: AssetImage('assets/loading.gif'),
                    height: 250,
                    fit: BoxFit.cover
                    ) 
...
Widget _customBotTercerDios(List<dynamic> data, BuildContext context){
  return Container(
    child: Column(
      children: [
        Text(data.elementAt(1)['mayas']['dios3'],style: TextStyle(color: Colors.black, fontSize: 20.0)),
      ]
    )
  );
}
...
Widget _customTopMito(List<dynamic> data, BuildContext context){
  return Container(
    child: Text(data.elementAt(1)['mayas']['nombre-mito'], style: TextStyle(color: Colors.black, fontSize: 30.0)),
  );
} 
...
Widget _customBotMito(List<dynamic> data, BuildContext context){
  return Container(
    child: Column(
      children: [
        Text(data.elementAt(1)['mayas']['mito'],style: TextStyle(color: Colors.black, fontSize: 20.0)),
      ]
    )
  );
}