...
List<Widget> _listDioses(List<dynamic> data, BuildContext context){
  ...
  final List<dynamic> dioses = data.elementAt(2)['mayas']['lista-dioses'];
...
Widget _customTopMito(List<dynamic> data, BuildContext context){
  return Container(
    child: Text(data.elementAt(2)['mayas']['nombre-mito'], style: TextStyle(color: Colors.black, fontSize: 30.0)),
  );
} 
...
Widget _customBotMito(List<dynamic> data, BuildContext context){
  return Container(
    child: Column(
      children: [
        Text(data.elementAt(2)['mayas']['mito'],style: TextStyle(color: Colors.black, fontSize: 20.0)),
      ]
    )
  );
}